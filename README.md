...
OpenFire is a hackathon project built for the "Build agents that act in the world" theme. It's an autonomous HR termination agent that monitors employee performance, decides who gets the axe, and delivers the bad news via a professionally passive-aggressive email — all while you're on vacation.
...
2. **Makes the call** — runs a scoring model against configurable "fire criteria" (missed deadlines, bad PRs, too many lunch breaks)
...
- **Next.js** — dashboard to review pending firings before OpenFire pulls the trigger
...
This is a hackathon joke project. Do not use OpenFire to actually fire your employees. Unless they really deserve it.

---

Built at Eragon Hackathon 2026 · Team OpenFire
